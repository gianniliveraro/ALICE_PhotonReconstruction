...
MAX_JOBS="10"                # Number of CPU threads to use.
FILES_PER_CHUNK=5            # N. AO2Ds per batch. Watch out for too large files! Memory = NJobs * FilesPerChunk * AvgFileSize
...
O2_CMD="o2-analysis-lf-findable-study ${OPTION} | o2-analysis-lf-str-derived-genqa ${OPTION} | o2-analysis-lf-strangenesstofpid ${OPTION} | o2-analysis-lf-v0mlscoresconverter ${OPTION} | o2-analysis-lf-strangederivedbuilder ${OPTION} | o2-analysis-propagationservice ${OPTION}  | o2-analysis-trackselection ${OPTION} | o2-analysis-pid-tpc-service ${OPTION} | o2-analysis-pid-tof-base ${OPTION} | o2-analysis-pid-tof-beta ${OPTION} | o2-analysis-pid-tof-full ${OPTION} | o2-analysis-multcenttable ${OPTION} | o2-analysis-ft0-corrected-table ${OPTION} | o2-analysis-event-selection-service ${OPTION} | o2-analysis-mm-track-propagation ${OPTION} | o2-analysis-fwdtrack-to-collision-associator ${OPTION} |  o2-analysis-mccollisionextra ${OPTION} --pipeline pid-tpc-service:2, strangenesstofpid: 2, propagationservice:2 --timeframes-rate-limit ${TIMEFRAMES} --aod-max-io-rate ${AOD_MAXIO} --shm-segment-size ${SHARED_MEMORY} --readers ${READERS}"
